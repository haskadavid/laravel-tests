...
All model test helpers are stored as a trait. This makes them super easy to import into our test class. Simply add `use Haska\Tests\ModelHelpers;` to the top of the class, and you should be good to go.
